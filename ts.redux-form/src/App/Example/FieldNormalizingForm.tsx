...
const lessThan = (otherField:any) =>
    (value:string, previousValue:string, allValues:any[]) => parseFloat(value) < parseFloat(allValues[otherField]) ? value : previousValue
const greaterThan = (otherField:any) =>
    (value:string, previousValue:string, allValues:any[]) => parseFloat(value) > parseFloat(allValues[otherField]) ? value : previousValue

const FieldNormalizingForm = (props:any) => {
